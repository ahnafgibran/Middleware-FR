...
@Entity
@Data
@Table(name = "docking_station", schema = "public")
public class DockingEntity {
    ...
    @Column(name = "docking_station_name", nullable = false)
    private String docking_station_name;

    @Column(name = "docking_station_ip_address", nullable = false)
    private String docking_station_ip_address;

    @Column(name = "docking_station_organization_id", nullable = false)
